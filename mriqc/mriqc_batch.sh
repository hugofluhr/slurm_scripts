...
#SBATCH -o /home/hfluhr/logs/learninghabits/mriqc/%x-%A/out/%x-%A-%a.out
#SBATCH -e /home/hfluhr/logs/learninghabits/mriqc/%x-%A/err/%x-%A-%a.err
...
singularity run --cleanenv -B /home/hfluhr/shares-hare/ds-learning-habits:/ds-learning-habits -B /scratch/hfluhr/workflows:/workflow /home/hfluhr/data/containers/arch/mriqc /ds-learning-habits /ds-learning-habits/derivatives/mriqc participant --participant-label $subject -w /workflow/learning-habits/dev/mriqc_defaced -m T1w